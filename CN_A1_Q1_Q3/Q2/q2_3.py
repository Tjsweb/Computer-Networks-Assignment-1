        ...
        if eth_type == 0x0800:  # IPv4
            ...
            if protocol == 6:  # TCP
                ...
                if tcp_header_info:
                    ...
                    # I have a TCP checksum “0xf436”. Cross-check with this packet's checksum --- Q3
                    checksum_hex = '0xf436'

                    # Calculate the checksum of the packet
                    tcp_data = tcp_packet[:tcp_header_length] + payload
                    
                    calculated_checksum = calculate_tcp_checksum(tcp_data)
                    
                    received_checksum = struct.unpack('!H', tcp_packet[16:18])[0]
                    received_checksum_hex = hex(received_checksum)

                    if(received_checksum_hex == checksum_hex):
