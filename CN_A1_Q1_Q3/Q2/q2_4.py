        ...
        if eth_type == 0x0800:  # IPv4
            ...
            if protocol == 6:  # TCP
                ...
                if tcp_header_info:
                    ...
                    # My device has an IP Address “123.134.156.178” --- Q4
                    ip_address = "123.134.156.178"
                    if(ip_address == src_ip):
                        sum = src_port + dest_port
                        ...
                        print(f"Sum of Source and Destination Port: {sum}")

                    # I come from localhost with port equals to sum of source and destination port 
                    if(src_port == 10987):
                        print(f"Source IP: {src_ip}, Source Port: {src_port}, Destination IP: {dest_ip}, Destination Port: {dest_port}")
                        print(f"ASCII Payload: {ascii_payload}")
